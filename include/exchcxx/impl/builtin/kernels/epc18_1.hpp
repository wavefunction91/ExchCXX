...
template <>
struct kernel_traits< BuiltinEPC18_1 > :
  public lda_screening_interface< BuiltinEPC18_1 > {
...
struct BuiltinEPC18_1 : detail::BuiltinKernelImpl< BuiltinEPC18_1 > {

  BuiltinEPC18_1( Spin p ) :
    detail::BuiltinKernelImpl< BuiltinEPC18_1 >(p) { }
  
  virtual ~BuiltinEPC18_1() = default;
