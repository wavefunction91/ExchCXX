...
struct kernel_traits< BuiltinPBE_X > :
  public gga_screening_interface< BuiltinPBE_X > {
  ...
  BUILTIN_KERNEL_EVAL_RETURN
    ...
    constexpr double t14 = constants::m_pi_sq;
  ...
  BUILTIN_KERNEL_EVAL_RETURN
    ...
    constexpr double t11 = constants::m_pi_sq;
  ...
  BUILTIN_KERNEL_EVAL_RETURN
    ...
    constexpr double t20 = constants::m_pi_sq;
