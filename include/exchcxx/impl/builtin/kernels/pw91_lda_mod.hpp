...
template <>
struct kernel_traits< BuiltinPW91_LDA_MOD > :
  public lda_screening_interface< BuiltinPW91_LDA_MOD > {
  ...
  static constexpr double a_0 = 0.0310907;
  static constexpr double a_1 = 0.01554535;
  static constexpr double a_2 = 0.0168869;
  ...
  BUILTIN_KERNEL_EVAL_RETURN
    ...
    const double t37 = safe_math::pow( t21 / 0.4e1, t36 );
  ...
  BUILTIN_KERNEL_EVAL_RETURN
    ...
    const double t66 = safe_math::sqrt( t21 );
  ...
  BUILTIN_KERNEL_EVAL_RETURN
    ...
    const double t58 = safe_math::cbrt( t57 );
    const double t60 = 0.1e1 - t56;
    const double t61 = safe_math::cbrt( t60 );
    ...
    const double t90 = safe_math::pow( t35, t89 );
    ...
    const double t97 = safe_math::log( t96 );
    const double t104 = 0.1e1 + t101 * t13 / 0.4e1;
    const double t120 = safe_math::pow( t35, t119 );
  ...
  BUILTIN_KERNEL_EVAL_RETURN
    ...
    const double t159 = safe_math::sqrt( t22 );
...
struct BuiltinPW91_LDA_MOD : detail::BuiltinKernelImpl< BuiltinPW91_LDA_MOD > {

  BuiltinPW91_LDA_MOD( Spin p ) :
    detail::BuiltinKernelImpl< BuiltinPW91_LDA_MOD >(p) { }
  
  virtual ~BuiltinPW91_LDA_MOD() = default;
