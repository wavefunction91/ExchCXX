...
struct kernel_traits< BuiltinVWN3 > :
  ...
  BUILTIN_KERNEL_EVAL_RETURN
    ...
    const double t24 = safe_math::atan( 0.47309269095601128300e1 / t21 );
  ...
  BUILTIN_KERNEL_EVAL_RETURN
    ...
    const double t44 = safe_math::atan( 0.47309269095601128300e1 / t41 );
    ...
    const double t103 = safe_math::atan( 0.66920720466459414830e1 / t100 );
    ...
    const double t117 = safe_math::cbrt( t116 );
    const double t119 = 0.1e1 - t115;
    const double t120 = safe_math::cbrt( t119 );
