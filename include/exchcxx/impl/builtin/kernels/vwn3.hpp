...
struct kernel_traits<BuiltinVWN3> {
  ...
  BUILTIN_KERNEL_EVAL_RETURN 
    ...
    const double t14 = t10 / 4. + 0.186372e1 * t12 + 0.129352e2;
    ...
    const double t27 = t12 / 2. + 0.10498e0;
  ...
  BUILTIN_KERNEL_EVAL_RETURN
    ...
    const double t50 = -t42 / 12. - 0.31062 * t45 * t46 * t33;
    ...
    const double t68 = 0.378469910464e2 * t64 + 1.;
    ...
    vxc = t20 + t25 + t31 + 
      rho * (0.10363566666666666667e-1 * t61 + 0.39765745675026770179e-1 * t72 + 
        0.96902277115443742139e-3 * t83);
  }
