...
struct kernel_traits< BuiltinPBE_C > :
  ...
  BUILTIN_KERNEL_EVAL_RETURN
    ...
    const double t33 = rho * rho;
    const double t35 = 0.1e1 / t7 / t33;
    const double t46 = exp( 0.62181400000000000000e-1 * t31 * t43 );
  ...
  BUILTIN_KERNEL_EVAL_RETURN
    ...
    const double t112 = exp( -t109 * t110 );
