...
struct kernel_traits< BuiltinB88 > :
  ...
  BUILTIN_KERNEL_EVAL_RETURN
    ...
    const double t23 = safe_math::sqrt( sigma );
    const double t24 = t22 * t23;
    const double t25 = t10 * rho;
    const double t26 = 0.1e1 / t25;
    const double t30 = safe_math::log( t23 * t8 * t26 + safe_math::sqrt( square( t23 * t8 * t26 ) + 0.1e1 ) );
  ...
  BUILTIN_KERNEL_EVAL_RETURN
    ...
    const double t66 = safe_math::sqrt( t65 );
  ...
  BUILTIN_KERNEL_EVAL_RETURN
    ...
    const double t19 = safe_math::sqrt( sigma );
    const double t20 = t7 * rho;
    const double t21 = 0.1e1 / t20;
    const double t22 = t19 * t21;
    const double t23 = safe_math::log( t22 + safe_math::sqrt( t22 * t22 + 0.1e1 ) );
  ...
  BUILTIN_KERNEL_EVAL_RETURN
    ...
    const double t58 = safe_math::sqrt( t57 );
  ...
  BUILTIN_KERNEL_EVAL_RETURN
    ...
    const double t24 = safe_math::cbrt( rho_a );
    const double t25 = t24 * t24;
    const double t27 = 0.1e1 / t25 / t23;
    const double t29 = safe_math::sqrt( sigma_aa );
    const double t31 = 0.1e1 / t24 / rho_a;
    const double t32 = t29 * t31;
    const double t33 = safe_math::log( t32 + safe_math::sqrt( t32 * t32 + 0.1e1 ) );
    ...
    const double t56 = safe_math::sqrt( sigma_bb );
    const double t58 = 0.1e1 / t52 / rho_b;
    const double t59 = t56 * t58;
    const double t60 = safe_math::log( t59 + safe_math::sqrt( t59 * t59 + 0.1e1 ) );
  ...
  BUILTIN_KERNEL_EVAL_RETURN
    ...
    const double t164 = safe_math::sqrt( t163 );
