...
TEST_CASE( "Polarized LDA XC Functionals", "[xc-lda]" ) {
  ...
  XCKernel slater( Kernel::SlaterExchange, Spin::Polarized );
  XCKernel vwn3  ( Kernel::VWN3,           Spin::Polarized );
...
TEST_CASE( "Unpolarized GGA XC Functionals", "[xc-gga]" ) {
  ...
  XCKernel b88( Kernel::B88,  Spin::Unpolarized );
  XCKernel lyp( Kernel::LYP,  Spin::Unpolarized );
  XCKernel vwn( Kernel::VWN3, Spin::Unpolarized );
...
TEST_CASE( "Polarized GGA XC Functionals", "[xc-gga]" ) {
  ...
  XCKernel b88( Kernel::B88,  Spin::Polarized );
  XCKernel lyp( Kernel::LYP,  Spin::Polarized );
  XCKernel vwn( Kernel::VWN3, Spin::Polarized );
